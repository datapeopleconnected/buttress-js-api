...
const _getAll = buttressAuthToken => {
  ...
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/contract`;
...
const _load = buttressId => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/contract/${buttressId}`;
...
const _saveAll = details => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/contract/bulk/add`;
    const json = JSON.stringify(details);
    restler
      .post(url, {
        query: {
...
const _update = (buttressId, details) => {
  return new Promise((resolve, reject) => {
    const url = `${Buttress.appURL}/contract/${buttressId}`;
    const json = JSON.stringify(details);
    restler
      .put(url, {
        query: {
...
const _bulkRemove = buttressIds => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/contract/bulk/delete`;
