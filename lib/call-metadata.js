 ...
 * @private
 */
var _loadMetadata = (buttressId, key, defaultValue) => {
  return new Promise((resolve, reject) => {
    var url = `${Buttress.url}/call/${buttressId}/metadata/${key}`;
    restler
...
var _saveMetadata = (buttressId, key, value) => {
  return new Promise((resolve, reject) => {
    var url = `${Buttress.url}/call/${buttressId}/metadata/${key}`;
    restler
      .post(url, {
...
var _rmMetadata = (buttressId, key) => {
  return new Promise((resolve, reject) => {
    var url = `${Buttress.url}/call/${buttressId}/metadata/${key}`;
    restler
      .del(url, {
