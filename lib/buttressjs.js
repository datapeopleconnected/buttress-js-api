...
class Buttress {
  ...
  initSchema() {
    const updateSchema = () => {
      ...
      return axios.put(`${this.coreURL}/app/schema`, this.options.schema, {params: {token: this.authToken}})
    ...
    const updateRoles = () => {
      ...
      return axios.put(`${this.coreURL}/app/roles`, this.options.roles, {params: {token: this.authToken}})
        .then((response) => response.data);
    };
