...
class User extends Schema {
  ...
  /**
   * @param {Object} username - user password
   * @param {Object} password - user name
   * @param {Object} options - request options
   * @return {Promise}
   */
  getLocalAuthUser(username, password, options) {
    options = Helpers.checkOptions(options, this.token);
    return this._request('get', `localAuth/${username}/${password}`, options);
  }
}
