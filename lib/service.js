...
const _getAll = buttressAuthToken => {
  ...
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/service`;
...
const _load = buttressId => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/service/${buttressId}`;
...
const _saveAll = details => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/service/bulk/add`;
    const json = JSON.stringify(details);
    restler
      .post(url, {
        query: {
...
const _bulkRemove = buttressIds => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/service/bulk/delete`;
