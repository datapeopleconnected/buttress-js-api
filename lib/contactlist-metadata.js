 ...
 * @private
 */
const _loadCampaignMetadata = (buttressCampaignId, key, defaultValue) => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.url}/campaign/${buttressCampaignId}/metadata/${key}`;
    restler
...
const _saveCampaignMetadata = (buttressCampaignId, key, value) => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.url}/campaign/${buttressCampaignId}/metadata/${key}`;
    restler
      .post(url, {
...
const _rmCampaignMetadata = (buttressCampaignId, key) => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.url}/campaign/${buttressCampaignId}/metadata/${key}`;
    restler
      .del(url, {
