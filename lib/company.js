...
const _getAll = buttressAuthToken => {
  ...
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/company`;
...
const _bulkLoad = buttressIds => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/company/bulk/load`;
...
const _load = buttressId => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/company/${buttressId}`;
...
const _saveAll = details => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/company/bulk/add`;
    const json = JSON.stringify(details);
    restler
      .post(url, {
        query: {
...
const _bulkRemove = buttressIds => {
  return new Promise((resolve, reject) => {
    let url = `${Buttress.appURL}/company/bulk/delete`;
    const json = JSON.stringify(buttressIds);
    restler
      .post(url, {
        query: {
